...
urlpatterns = [
    ...
    path("users/<uuid:pk>/update-account-type/", UpdateAccountTypeView.as_view(), name="update_account_type"),
    ...
    path("forget-password/", RequestResetPasswordView.as_view(), name="forget_password"),
